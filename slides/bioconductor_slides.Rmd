...
"Base R" is standard packages and CRAN, mostly designed for use by statisticians.

Tidyverse is a set of modern packages, also on CRAN.

Tidyverse is easy to pick up, has made R much more widely accessible. Key concepts are tidy data and pipelines.

Bioconductor is a separate package repository.
...
* `DNAString`, `DNAStringSet`, `AAString`
